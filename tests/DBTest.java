...
class DBDriver extends TestDriver implements GlobalConst {
  ...
  protected boolean test1 () {
    ...
    System.out.println("DBTest 1 - Read: " + PCounter.rcounter + " - Write: " + PCounter.wcounter);
  ...
  protected boolean test2 () {
    ...
    System.out.println("DBTest 2 - Read: " + PCounter.rcounter + " - Write: " + PCounter.wcounter);
  ...
  protected boolean test3 () {
    ...
    System.out.println("DBTest 3 - Read: " + PCounter.rcounter + " - Write: " + PCounter.wcounter);
