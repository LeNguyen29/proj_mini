...
public class TestDriver {
  ...
  protected boolean runAllTests() {
    ...
    System.out.println("Test 1 - Read: " + PCounter.rcounter + " - Write: " + PCounter.wcounter);

    PCounter.initialize();
    if (!test2()) { _passAll = FAIL; }
    System.out.println("Test 2 - Read: " + PCounter.rcounter + " - Write: " + PCounter.wcounter);
    
    PCounter.initialize();
    if (!test3()) { _passAll = FAIL; }
    System.out.println("Test 3 - Read: " + PCounter.rcounter + " - Write: " + PCounter.wcounter);
    
    PCounter.initialize();
    if (!test4()) { _passAll = FAIL; }
    System.out.println("Test 4 - Read: " + PCounter.rcounter + " - Write: " + PCounter.wcounter);
    
    PCounter.initialize();
    if (!test5()) { _passAll = FAIL; }
    System.out.println("Test 5 - Read: " + PCounter.rcounter + " - Write: " + PCounter.wcounter);
    
    PCounter.initialize();
    if (!test6()) { _passAll = FAIL; }
    System.out.println("Test 6 - Read: " + PCounter.rcounter + " - Write: " + PCounter.wcounter);
