...
public boolean runTests () {
  ...
  protected boolean test1 ()  {
    ...
    System.out.println("HFTest 1 - Read: " + PCounter.rcounter + " - Write: " + PCounter.wcounter);
  ...
  protected boolean test2 () {
    ...
    System.out.println("HFTest 2 - Read: " + PCounter.rcounter + " - Write: " + PCounter.wcounter);
  ...
  protected boolean test3 () {
    ...
    System.out.println("HFTest 3 - Read: " + PCounter.rcounter + " - Write: " + PCounter.wcounter);
  ...
  protected boolean test4 () {
    ...
    System.out.println("HFTest 4 - Read: " + PCounter.rcounter + " - Write: " + PCounter.wcounter);
