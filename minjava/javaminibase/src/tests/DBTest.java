...
class DBDriver extends TestDriver implements GlobalConst {
  ...
  protected boolean test1 () {
    ...
    if ( status == OK )
      ...
      System.out.println("After DBTest 1 - Reads: " + PCounter.rcounter + ", Writes: " + PCounter.wcounter);
    return status;  
  ...
  protected boolean test2 () {
    ...
    if ( status == OK )
      ...
      System.out.println("After DBTest 2 - Reads: " + PCounter.rcounter + ", Writes: " + PCounter.wcounter);
  ...
  protected boolean test3 () {
    ...
    if ( status == OK )
      ...
      System.out.println("After DBTest 3 - Reads: " + PCounter.rcounter + ", Writes: " + PCounter.wcounter);
    return status;
  }
  ...
  protected boolean test4 ()  {
    ...
    if ( status == OK ) {
      ...
      System.out.println("After DBTest 4 - Reads: " + PCounter.rcounter + ", Writes: " + PCounter.wcounter);
    }
