...
public class TestDriver {
  ...
  protected boolean runAllTests() {
    ...
    System.out.println("After " + testName() + " Test 1 - Reads: " + PCounter.rcounter + ", Writes: " + PCounter.wcounter);
    
    PCounter.initialize();
    if (!test2()) { _passAll = FAIL; }
    System.out.println("After " + testName() + " Test 2 - Reads: " + PCounter.rcounter + ", Writes: " + PCounter.wcounter);

    PCounter.initialize();
    if (!test3()) { _passAll = FAIL; }
    System.out.println("After " + testName() + " Test 3 - Reads: " + PCounter.rcounter + ", Writes: " + PCounter.wcounter);

    PCounter.initialize();
    if (!test4()) { _passAll = FAIL; }
    System.out.println("After " + testName() + " Test 4 - Reads: " + PCounter.rcounter + ", Writes: " + PCounter.wcounter);

    PCounter.initialize();
    if (!test5()) { _passAll = FAIL; }
    System.out.println("After " + testName() + " Test 5 - Reads: " + PCounter.rcounter + ", Writes: " + PCounter.wcounter);

    PCounter.initialize();
    if (!test6()) { _passAll = FAIL; }
    System.out.println("After " + testName() + " Test 6 - Reads: " + PCounter.rcounter + ", Writes: " + PCounter.wcounter);
