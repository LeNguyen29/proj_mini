...
class BMDriver extends TestDriver implements GlobalConst {
  ...
  protected boolean test1 () {
    ...
    if ( status == OK )
      ...
      System.out.println("After BMTest 1 - Reads: " + PCounter.rcounter + ", Writes: " + PCounter.wcounter);
    return status;
  }
  ...
  protected boolean test2 () {
    ...
    if ( status == OK )
      ...
      System.out.println("After BMTest 2 - Reads: " + PCounter.rcounter + ", Writes: " + PCounter.wcounter);
    return status;
  }
  ...
  protected boolean test3 () {
    ...
    if ( status == OK )
      ...
      System.out.println("After BMTest 3 - Reads: " + PCounter.rcounter + ", Writes: " + PCounter.wcounter);
    return status;
}
