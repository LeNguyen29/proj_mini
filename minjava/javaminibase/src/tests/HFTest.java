...
public boolean runTests () {
  ...
  protected boolean test1 ()  {
    ...
    if ( status == OK )
        ...
        System.out.println("After HFTest 1 - Reads: " + PCounter.rcounter + ", Writes: " + PCounter.wcounter);
  ...
  protected boolean test2 () {
    ...
    if ( status == OK )
        ...
        System.out.println("After HFTest 2 - Reads: " + PCounter.rcounter + ", Writes: " + PCounter.wcounter);
    return status; 
  ...
  protected boolean test3 () {
    ...
    if ( status == OK )
      ...
      System.out.println("After HFTest 3 - Reads: " + PCounter.rcounter + ", Writes: " + PCounter.wcounter);
    return status; 
  ...
  protected boolean test4 () {
    ...
    if ( status == OK )
      ...
      System.out.println("After HFTest 4 - Reads: " + PCounter.rcounter + ", Writes: " + PCounter.wcounter);
    return (status == OK);
  }
